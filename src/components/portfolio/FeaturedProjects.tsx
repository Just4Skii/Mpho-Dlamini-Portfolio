            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                ...
                <span style={{
                  ...
                  padding: '2px 6px',
                  borderRadius: '9999px',
                  background: p.status === 'live' ? 'rgba(16, 185, 129, 0.15)' : 'rgba(245, 158, 11, 0.15)',
                  color: p.status === 'live' ? '#34d399' : '#fbbf24',
                  border: `1px solid ${p.status === 'live' ? 'rgba(52, 211, 153, 0.3)' : 'rgba(245, 158, 11, 0.3)'}`
                }}>
                  {p.status === 'live' ? '● Live Project' : 'Coming Soon'}
                </span>
              </div>
